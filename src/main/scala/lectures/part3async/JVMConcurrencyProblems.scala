...
object JVMConcurrencyProblems {
  ...
  def buySafe(bankAccount: BankAccount, thing: String, price: Int): Unit = {
    bankAccount.synchronized { // doesn't allow multiple threads to run critical section AT THE SAME TIME
  ...
  /**
   ...
   3 - "sleep fallacy": whats thew value of message
   */
  ...
  /*
    ...
    min value = 1 -> because of the below
