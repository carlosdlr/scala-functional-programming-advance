...
object HighestKindedTypes extends App {
  ...
  // use HKT
  trait Monad[F[_], A] { // higher-kinded class
  ...
  println(multiply(new MonadOption[Int](Some(2)),
    new MonadOption[String](Some("scala"))))
